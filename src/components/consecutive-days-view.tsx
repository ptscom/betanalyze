...
import type { ConsecutiveDaysAggregateResult } from "@/lib/analyses/types";
import { formatDate, formatPercent, formatPlace, formatPrice } from "@/lib/utils/format";

interface ConsecutiveDaysViewProps {
  analysis: ConsecutiveDaysAggregateResult;
}

export function ConsecutiveDaysView({ analysis }: ConsecutiveDaysViewProps) {
    ...
    <div className="space-y-8">
      <section className="grid gap-4 md:grid-cols-3">
        <StatCard
          ...
          hint={`${analysis.totalBets - analysis.eligibleBets} had no ${analysis.streakLength}-day ${moveLabel} streak`}
        />
        <StatCard
        ...
        <StatCard
          ...
          hint={`${analysis.streakLength} consecutive ${moveLabel} closes`}
        />
      </section>
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <ChartCard
          ...
          description={`Final place for the first candidate with ${analysis.streakLength} consecutive ${moveLabel} daily closes.`}
        >
          <div className="h-64">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-5">
          ...
          <ul className="mt-3 space-y-2 text-sm text-zinc-600">
            <li>
              A signal fires when a candidate&apos;s daily closing price moves{" "}
              {moveLabel} for {analysis.streakLength} consecutive days (strict{" "}
              {isUp ? ">" : "<"} day-over-day).
            </li>
            <li>
              Flat days break the streak. The first qualifying candidate in the
              window is the pick for that bet.
            </li>
            <li>
      ...
      <section className="rounded-xl border border-zinc-200 bg-white p-5">
        ...
        <p className="mt-1 text-sm text-zinc-600">
          Candidate price on the last day of the {analysis.streakLength}-day{" "}
          {moveLabel} streak, grouped by bracket.
        </p>
            ...
            <tbody className="divide-y divide-zinc-100">
              {bracketRows.length === 0 ? (
                <tr>
                  ...
                  >
                    No {analysis.streakLength}-day {moveLabel} signals in this
                    window.
                  </td>
                </tr>
              ) : (
      ...
      <section className="space-y-4">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-600">
            First {analysis.streakLength}-day {moveLabel} streak and whether that
            candidate won.
          </p>
        </div>
